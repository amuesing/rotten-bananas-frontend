...
function MediaList({media, review, handleReviewUpdate, handleAddReview, handleDeleteReview, activeUser, userArray}) {
    ...
    return <MediaCard userArray={userArray} handleReviewUpdate={handleReviewUpdate} handleDeleteReview={handleDeleteReview} activeUser={activeUser} key={mediaObj.id} id={mediaObj.id} media={mediaObj} reviews={mediaReviews} handleAddReview={handleAddReview}/>})
        return (
        <div>
        {mediaObject}  
        </div>
